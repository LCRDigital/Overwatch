  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case RealTimeActivityRow:
            return RealTimeActivityRow(data);
          case AuditLogsRow:
            return AuditLogsRow(data);
          case SiteConditionsRow:
            return SiteConditionsRow(data);
          case DashboardOverviewRow:
            return DashboardOverviewRow(data);
          case PaceLogRow:
            return PaceLogRow(data);
          case GlideAuditLogRow:
            return GlideAuditLogRow(data);
          case UnitIssuesRow:
            return UnitIssuesRow(data);
          case UnitsRow:
            return UnitsRow(data);
          case CurrentPaceStatusRow:
            return CurrentPaceStatusRow(data);
          case RecentFieldActivityRow:
            return RecentFieldActivityRow(data);
          case ConflictsRow:
            return ConflictsRow(data);
          case DashboardMetricsViewRow:
            return DashboardMetricsViewRow(data);
          case CdcEventsRow:
            return CdcEventsRow(data);
          case SyncSystemStatusRow:
            return SyncSystemStatusRow(data);
          case ConflictResolutionsRow:
            return ConflictResolutionsRow(data);
          case DashboardMetricsRow:
            return DashboardMetricsRow(data);
          case DealsWithRecentActivityRow:
            return DealsWithRecentActivityRow(data);
          case SyncJobLogsRow:
            return SyncJobLogsRow(data);
          case ActivitySummaryRow:
            return ActivitySummaryRow(data);
          case RecentActivityRow:
            return RecentActivityRow(data);
          case DealsRow:
            return DealsRow(data);
          case WebhookLogsRow:
            return WebhookLogsRow(data);
          case UnitTypeRequirementsRow:
            return UnitTypeRequirementsRow(data);
          default:
            return null;
        }
