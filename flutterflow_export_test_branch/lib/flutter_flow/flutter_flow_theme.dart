...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color border = const Color(0x66FFFFFF);
  late Color background = const Color(0x1AFFFFFF);
  late Color lila = const Color(0x3D6D2CE4);
  late Color purple = const Color(0x3D260561);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color border = const Color(0x66FFFFFF);
  late Color background = const Color(0x1A000000);
  late Color lila = const Color(0x3E6D2CE4);
  late Color purple = const Color(0x3C260561);
}
